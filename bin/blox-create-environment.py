...
def run_apigateway(params):
    ...
    command = ["apigateway", "test-invoke-method", "--rest-api-id",
               ...
               restResource['StackResourceDetail']['PhysicalResourceId'], "--http-method", "POST", "--headers", "{}",
               "--path-with-query-string", "/v1/environments", "--body", json.dumps(body)]
...
def run_local(params):
    ...
    api.queryParams = {}
    api.data = {'name': params.environment, 'instanceGroup': {'cluster': params.cluster},
